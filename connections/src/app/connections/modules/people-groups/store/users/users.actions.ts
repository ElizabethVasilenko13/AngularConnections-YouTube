...
export const createConversationAction = createAction('[Conversation] Create Conversation', props<{companion: string}>());
export const createConversationSuccessAction = createAction('[Conversation] Create Conversation Success', props<{companion: string;  conversationId: string}>());
...
export const  loadConversationMessagesSuccessAction = createAction('[Conversation] Load Conversation Success', props<{ conversationData: ConverastionMessagesProps; time:number; conversationID: string  }>());
export const  loadConversationMessagesFailedAction = createAction(
  '[Conversation] Load Conversation Failed',
props<{ error: AuthError }>());

export const loadConversationMessagesSinceAction = createAction('[Conversation] Load Conversation Since', props<{conversationID: string; time: number }>());
export const  loadConversationMessagesSinceSuccessAction = createAction('[Conversation] Load Conversation Success Since', props<{ conversationData: ConverastionMessagesProps; time:number; conversationID: string  }>());
...
export const postConversationMessageAction = createAction('[Conversation] Post Message', props<{conversationID: string; message: string; time: number}>());
